...
```{r agnes_dend, warning = FALSE, message = FALSE, echo = FALSE, paged.print = FALSE, fig.width = 18, fig.height = 4}
...
```{r diana_dend, echo = FALSE, warning = FALSE, paged.print = FALSE, fig.width = 18, fig.height = 4}
...
ag_labcolors <- unsup_labs_reord_ag %>% 
  ...
  mutate(x = row_number(),
         ...
         leafcolor = case_when(
           BMI_cat == "UW" ~ "#FFFF00", # Old value dark purple: "#3F345E"
           BMI_cat == "HW" ~ "#008318", # Old value slate bue: "#34495E"
           BMI_cat == "OW" ~ "#FF8D03", # Old value dark green: "#355E44"
           BMI_cat == "OB" ~ "#FF0000", # Old value dark rose "#5E343F"
  )) %>% 
...
agnes_dend_clust <- nhanes_agnes %>% 
  ...
  #set("labels", unsup_labs_reord_ag$BMI_cat) %>% 
  #set("labels_cex", 0.75) %>% 
  #set("labels_colors", ag_labcolors$labcolor) %>% 
...
```{r diana_dend_clust, echo = FALSE, warning = FALSE, paged.print = FALSE, fig.width = 12, fig.height = 4}
...
diana_dend_clust <- nhanes_diana %>% 
  ...
  set("labels", unsup_labs_reord_di$BMI_cat) %>% 
  set("labels_cex", 0.5) %>% 
  set("labels_colors", di_labcolors$labcolor) %>% 
...
diana_dend_clust_gg <- ggplot(diana_dend_clust_ggd) +
  theme(axis.line = element_blank(),
        axis.text.x = element_blank(),
        axis.text.y = element_blank(),
        axis.ticks = element_blank(),
